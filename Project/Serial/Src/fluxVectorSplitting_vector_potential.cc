#include "fluxVectorSplitting_vector_potential.h"
#include <cstdlib>

void FVS_vector_potential::fluxReconstruction(double * cons, double * prims, double * aux, double * f, double * frecon, int dir, int vars)
{
  // Syntax
  Data * d(this->data);
